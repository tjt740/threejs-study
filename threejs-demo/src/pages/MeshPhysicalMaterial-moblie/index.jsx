...
export default function ThreeComponent() {
    ...
    const init = () => {
        ...
        rgbeLoader.load(
            require('../MeshPhysicalMaterial-demo/texture/environment.hdr'),
            (envMap) => {
        ...
        gltfLoader.loadAsync(require('./mobile/iphone.glb')).then((glb) => {
            const frontBackgroundMesh =
                glb.scene.getObjectByName('Body_Wallpaper_0');
            console.log(frontBackgroundMesh);

            // 设置自发光贴图 .emissiveMap 和 自发光贴图颜色 .emissive 和 发光强度 .emissiveIntensity
            frontBackgroundMesh.material.emissiveMap =
                new THREE.TextureLoader().load(
                    require('./mobile/wallpaper.jpg')
                );
            frontBackgroundMesh.material.emissive = new THREE.Color(0xffffff);
            frontBackgroundMesh.material.emissiveIntensity = 1;
