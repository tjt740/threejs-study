            ...
            (texture) => {
                ...
                const planeMaterial = new THREE.MeshPhongMaterial({
                    ...
                    aoMap: new THREE.TextureLoader().load(
                        require('./texture/plank_flooring_ao_1k.jpg')
                    ),
                    // 基础贴图
                    map: new THREE.TextureLoader().load(
                        require('./texture/plank_flooring_diff_1k.jpg')
                    ),
                    // 法线贴图
                    normalMap: new THREE.TextureLoader().load(
                        require('./texture/plank_flooring_nor_gl_1k.jpg')
                    ),
                ...
                // 用rgbeLoader加载的.hdr文件给planeMaterial envMap赋值
