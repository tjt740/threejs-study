...
export default function ThreeComponent() {
    ...
    const init = () => {
        ...
        // 创建球体和地面
        const sphereGeometry = new THREE.SphereGeometry(3, 64, 16);
        ...
        // 创造物理世界的物体
        const cannonCube = new CANNON.Body({
            // 物体
        ...
        // 设置物理世界地面位置
        cannonPlaneBody.position.set(0, -5, 0);
        // 旋转物理世界平面
        ...
        function render(t) {
            ...
            sphere1.position.copy(cannonCube.position); // === sphere1.position = cannonCube.position;
