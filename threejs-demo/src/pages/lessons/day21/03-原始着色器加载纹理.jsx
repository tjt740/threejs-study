            ...
            */
            vertexShader: `   
                ...
                void main(){
                    ...
                    //3️⃣ 设置着色器变成波浪折角（电暖器形状） 取决于 PlaneGeometry 顶点数
                    modelPosition.z = sin(modelPosition.x * 1.0)*0.5 ;
                    modelPosition.z += sin((modelPosition.y)  * 1.0)*0.5 ;
                    


                    //4️⃣ 变量 vElevation = modelPosition.z;
                    vElevation = modelPosition.z;

                  	//5️⃣ 使用 声明的 modelPosition   <模型矩阵>*<顶点坐标> 位置 (-0.5,0.5)
            ...
            fragmentShader: `
                ...
                //6️⃣ 片元着色器 声明 vElevation，使用 顶点着色器声明的 vElevation；
                varying float vElevation;
                ...
                void main(){
                    ...
                    //7️⃣ 声明 “高度” 给颜色使用。因为事浮点数 所以用 float 。 基础数据类型：int、float、double、uint和bool。
