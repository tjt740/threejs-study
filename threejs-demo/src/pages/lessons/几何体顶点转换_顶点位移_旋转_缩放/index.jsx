...
export default function ThreeComponent() {
    ...
    const init = () => {
        ...
        const bufferPositionArray = new Float32Array([
            0, 0, 0, 0, 5, 0, 5, 5, 0, 5, 5, 0, 5, 0, 0, 0, 0, 0,
        ]);
        // 设置自定义组件顶点
        bufferGeometry.setAttribute(
            'position',
            new THREE.BufferAttribute(bufferPositionArray, 3)
        );
        // bufferGeometry.translate(5, 0, 0); // 会更改原点 [5, 0, 0, 5, 5, 0, 10, 5, 0, 10, 5, 0, 10, 0, 0, 5, 0, 0, 】

        bufferGeometry.rotateZ(Math.PI / 4);
        bufferGeometry.scale(1, 1.5, 2);
