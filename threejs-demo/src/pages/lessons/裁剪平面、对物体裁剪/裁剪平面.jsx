...
export default function ThreeComponent() {
    ...
    const init = () => {
        ...
        scene.add(boxMesh);
        boxMesh.position.x = 25;

        // 创建裁剪平面 (向y轴上方裁剪)
        const clipPlane1 = new THREE.Plane(new THREE.Vector3(0, 1, 0), 0);
        // 创建裁剪平面 (向x轴上右方裁剪)
        const clipPlane2 = new THREE.Plane(new THREE.Vector3(1, 0, 0), 0);
        // 给扭结图形材质设置 裁剪平面
        // torusKnotMesh.material.clippingPlanes = [clipPlane1, clipPlane2];
        renderer.clippingPlanes = [clipPlane1, clipPlane2];
        // 设置WebGLRenderer.localClippingEnabled = true;
        renderer.localClippingEnabled = true;
        // 裁剪平面交集还是并集
        torusKnotMaterial.clipIntersection = true;
