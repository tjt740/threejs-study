...
export default function ThreeComponent() {
    ...
    const init = () => {
        ...
        torusKnotMesh.material.clippingPlanes = [clipPlane];
        // 裁剪新的扭结几何体
        torusKnotMesh1.material.clippingPlanes = [clipPlane];
        renderer.localClippingEnabled = true;

        // 创建一个金属面
        const metalPlaneGeometry = new THREE.PlaneGeometry(50, 50, 512, 512);
        const metalPlaneMaterial = new THREE.MeshPhysicalMaterial({
            color: 0xcccccc,
            metalness: 0.95,
            roughness: 0.1,
            stencilWrite: true, // 设置允许进行模板缓冲操作
            stencilRef: 1, // 设置模板比较基准值 进行两个物体见比较 （自定义数字大小）
        ...
        scene.add(metalMesh);
        metalMesh.rotation.x = -Math.PI / 2;
        /*
         * ------------end ----------
         */
