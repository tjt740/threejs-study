...
export default function ThreeComponent() {
    ...
    const init = () => {
        ...
        // 变大变更细腻
        const ballTarget1 = new THREE.BoxGeometry(3, 6, 3).attributes.position;
        // 变小变粗糙
        const ballTarget2 = new THREE.BoxGeometry(6, 3, 3).attributes.position;

        // 设置几何体顶点变形目标数据，可以设置1组或多组
        boxGeometry.morphAttributes.position = [ballTarget1, ballTarget2];

        const boxMesh = new THREE.Mesh(boxGeometry, boxMaterial);

        // 更新Mesh的morphTargets，但会对 .morphTargetInfluences 产生影响，重置为一个空数组。
        boxMesh.updateMorphTargets();
        ...
        //     duration: 1,
        //     onUpdate: () => {
        //         boxMesh.morphTargetInfluences[0] = parmas.t1.value;
        //     },
        // });
        ...
        //     duration: 2,
        //     onUpdate: () => {
        //         boxMesh.morphTargetInfluences[1] = parmas.t2.value;
        //     },
        // });
        ...
        // 创建关键帧动画
        const animationClips = new THREE.AnimationClip('tjt', 6, [kf1, kf2]);
        // 创建动画混合器、动画播放器
        const mixer = new THREE.AnimationMixer(boxMesh);
        // 给动画播放器创建缓存动画器
        const animationAction = mixer.clipAction(animationClips);
        // 播放动画
